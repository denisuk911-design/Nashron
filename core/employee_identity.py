...
_FIRST_NAMES = {
    "ru": {
        "ukrainian": {
            ...
            "male": ["Андрей", "Тарас", "Никита", "Олег", "Богдан", "Дмитрий", "Максим", "Артём", "Владислав", "Александр", "Ярослав", "Игорь"],
        },
        "other": {
    ...
    "uk": {
        "ukrainian": {
            ...
            "male": ["Андрій", "Тарас", "Микита", "Олег", "Богдан", "Дмитро", "Максим", "Артем", "Владислав", "Олександр", "Ярослав", "Ігор"],
        },
        "other": {
    ...
    "en": {
        "ukrainian": {
            ...
            "male": ["Andrii", "Taras", "Mykyta", "Oleh", "Bohdan", "Dmytro", "Maksym", "Artem", "Vladyslav", "Oleksandr", "Yaroslav", "Ihor"],
        },
        "other": {
