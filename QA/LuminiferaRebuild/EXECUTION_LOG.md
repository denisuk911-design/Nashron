...
VERIFIED: The capture runner now uses bundled Playwright Chromium by default, avoiding the system Chrome DevTools policy failure. Final packaged captures completed with `unavailable=[]` at 1920x1080 and 1440x900; dynamic Settings copy and header workspace-select contrast were corrected before the final rebuild.
EVIDENCE: `QA/LuminiferaRebuild/V3/V35_VISUAL_REFINEMENT_2026-08-31.md`; `QA/LuminiferaRebuild/V3/captures/v35-1920-final/manifest.json`; `QA/LuminiferaRebuild/V3/captures/v35-1440-final/manifest.json`.
