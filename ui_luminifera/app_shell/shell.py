...
class LuminiferaShell(QWidget):
    ...
    def __init__(
        self,
        content: QWidget,
        organization_selector: QComboBox,
        callbacks: dict[str, Callable[[], None]],
        *,
        owner_avatar_path: str = "",
        onboarding_language_selector: QComboBox | None = None,
    ...
    def _build_sidebar(self) -> QWidget:
        ...
        for key, symbol, label in (
            ...
            button = self._navigation_button(key, symbol, label)
        ...
        iris_caption = QLabel("AI-супервайзер")
    ...
    def _build_topbar(
        ...
        organization_selector: QComboBox,
        owner_avatar_path: str,
        onboarding_language_selector: QComboBox | None,
    ) -> QWidget:
