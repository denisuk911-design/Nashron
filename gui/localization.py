...
TEXT = {
    "ru": {
        ...
        "errors": "Ошибки",
        "no": "нет",
        "provider_page_note": "Каталог ИИ-подключений. Рабочими считаются только интеграции с адаптером и успешной проверкой выполнения.",
    ...
    "uk": {
        ...
        "errors": "Помилки",
        "no": "ні",
        "provider_page_note": "Каталог ШІ-підключень. Робочими вважаються лише інтеграції з адаптером та успішною перевіркою виконання.",
    ...
    "en": {
        ...
        "errors": "Errors",
        "no": "none",
        "provider_page_note": "AI connection catalog. Only integrations with an adapter and a successful execution check are marked as supported.",
